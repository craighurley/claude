...
claude mcp add --transport stdio --scope user mcp-devtools --env DISABLED_TOOLS="sequential_thinking,think" --env ENABLE_ADDITIONAL_TOOLS="aws_documentation,code_skim,murican_to_english,process_document,terraform_documentation" -- "$HOME/go/bin/mcp-devtools"
