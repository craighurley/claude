---
name: apply-company-styles
description: Provides guidelines for applying company brand styles to diagrams and frontend components. Use when asked to create visuals that need to align with company branding.
---

# Rules For Applying Company Brand Styles

When creating visual diagrams or frontend components, you can apply the following style guidelines to ensure consistency with the company brand identity.

## Colour Scheme

- You should aim to use the following primary colours from the company brand palette.
...
Example Mermaid class definitions to apply company brand styles to diagrams
...
This information should help you maintain visual consistency with the company brand across diagrams and frontend components.
